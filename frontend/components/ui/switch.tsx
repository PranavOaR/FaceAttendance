            ...
            <>
                <div
                    className={cn(
                        ...
                        /* Focus Visible */
                        "group-data-[focus-visible]:outline-none group-data-[focus-visible]:ring-2 group-data-[focus-visible]:ring-blue-500 group-data-[focus-visible]:ring-offset-2",
                        /* Disabled */
                        "group-data-[disabled]:cursor-not-allowed group-data-[disabled]:opacity-50",
                        /* Selected - Dark blue when ON */
                        "bg-gray-300 dark:bg-gray-600 group-data-[selected]:bg-blue-600 group-data-[selected]:dark:bg-blue-500",
                        /* Readonly */
